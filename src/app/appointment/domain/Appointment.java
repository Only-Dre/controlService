...
import app.physiotherapist.PhysiotherapistEntity;
...
public class Appointment {
    ...
    public Appointment(Long id, Patient patient, PhysiotherapistEntity physiotherapistEntity, String procedures, String date, String startHour, String endHour, String duration, String procedureValue) {
        this.id = id;
